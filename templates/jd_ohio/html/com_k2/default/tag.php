				...
				<div class="tagItemContent-main">
				  ...
				  <div class="tag_item_info clearfix">
					...
					<span class="tagItemDateCreated">
						<span><i class="fa fa-clock-o" aria-hidden="true"></i></span> <?php echo JHTML::_('date', $item->created , JText::_('j F Y')); ?>
					</span>
					<?php endif; ?>
				  ...
				  <?php endif; ?>
					...
					<div class="tagItemReadMore">
						<a class="k2ReadMore sppb-btn-default btn" href="<?php echo $item->link; ?>">
