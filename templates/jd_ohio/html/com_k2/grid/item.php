...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemHeader clearfix">
		...
		<!-- Item Author -->
		<div class="itemAuthor-main">
			<span class="itemAuthor" title="Author">
		...
		<!-- Item tags -->
		<div class="itemTagsBlock" title="Tags">
		...
		<!-- Date created -->
		<div class="itemDateCreated-main">
			<span class="itemDateCreated" title="Created Date">
		...
		<!-- Item date modified -->
		<div class="itemDateModified-main">
			<span class="itemDateModified" title="Modified Date">
			...
			<!-- Anchor link to comments below - if enabled -->
				<?php if(!empty($this->item->event->K2CommentsCounter)): ?>
					...
					<?php else: ?>
						...
						<div class="itemCommentsLink-main">
							<a class="itemCommentsLink k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
								<i class="fa fa-comments" aria-hidden="true"></i> <span><?php echo $this->item->numOfComments; ?></span> Comments
							</a>
						</div>
						<?php else: ?>
						<div class="itemCommentsLink-main">
							<a class="itemCommentsLink k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor"><i class="fa fa-comments" aria-hidden="true"></i> 
							Comments</a>
						</div>
					<?php endif; ?>
				<?php endif; ?>
		...
		<div class="itemContentFooter">
			...
			<!-- Item Hits -->
			<span class="itemHits">
				<i class="fa fa-book" aria-hidden="true"></i> <span><?php echo $this->item->hits; ?></span> <?php echo JText::_('K2_TIMES'); ?>
			</span>
			<?php endif; ?>
	...
	<div class="socialButtonCode">
		...
		<!-- Item Social Button -->
			<div class="clearfix">
				...
				<span><?php echo $this->item->params->get('socialButtonCode'); ?></span>
			</div>
		<?php endif; ?>
	</div>
	...
	*/
			...
			<li class="<?php echo ($key%2) ? "odd" : "even"; ?>">
				<div class="inner">
					...
					<div class="itemHeader clearfix">
						...
						<div class="itemRelCat"><i class="fa fa-folder" aria-hidden="true"></i> <a href="<?php echo $item->category->link ?>"><?php echo $item->category->name; ?></a></div>
						<?php endif; ?>

						<?php if($this->item->params->get('itemRelatedAuthor')): ?>
						<div class="itemRelAuthor"><i class="fa fa-user" aria-hidden="true"></i> <a rel="author" href="<?php echo $item->author->link; ?>"><?php echo $item->author->name; ?></a></div>
						<?php endif; ?>
					</div>
	...
	<div class="itemNavigation">
		...
		<a class="itemPrevious" href="<?php echo $this->item->previousLink; ?>">&laquo; PREV</a>
		<?php endif; ?>

		<?php if(isset($this->item->nextLink)): ?>
		<a class="itemNext" href="<?php echo $this->item->nextLink; ?>">NEXT &raquo;</a>
		<?php endif; ?>
	</div>
	<?php endif; ?>
