    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      ...
      <?php endif; ?>
		...
		<?php if($params->get('itemIntroText')): ?>
			<p class="introtext"><?php echo $item->introtext; ?></p>
		<?php endif; ?>
      ...
      <span class="moduleItemDateCreated"><i class="fa fa-calendar" aria-hidden="true"></i><?php echo JHTML::_('date', $item->created, JText::_('j F Y')); ?></span>
      <?php endif; ?>
