...
class SppagebuilderAddonTestimonialpro extends SppagebuilderAddons {
    ...
    public function render() {
        ...
        foreach ($this->addon->settings->sp_testimonialpro_item as $key => $value) {
            ...
            $output .= '<div class="sppb-testimonial-client"><strong class="pro-client-name">'. $name .'</strong></div>';
           
            if ($controls) {
                $output .= '<a class="left sppb-carousel-control" role="button" data-slide="prev" href="#sppb-carousel1"><i class="fa fa-angle-left"></i></a>';
              $output .= '<a class="right sppb-carousel-control" role="button" data-slide="next" href="#sppb-carousel1"><i class="fa fa-angle-right"></i></a>';
